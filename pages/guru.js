...
export default function Guru() {
  ...
  // Hitung jumlah berdasarkan nilai di field shalat
  let jumlahShalat = 0;
  ...
  if (tipe === 'shalat') {
    list.forEach(s => {
      if (s.shalat?.toLowerCase() === 'ya') jumlahShalat++;
      else if (s.shalat?.toLowerCase() === 'tidak') jumlahTidakShalat++;
      else if (s.shalat?.toLowerCase().includes('sekolah')) jumlahTidakSekolah++;
    });
  }

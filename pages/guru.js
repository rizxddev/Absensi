...
export default function Guru() {
  ...
  const siswaTeks = dataSiswa?.absensi?.[tanggalPilih]
    ? formatRekap('siswa', dataSiswa, tanggalPilih)
    : 'Rekap Siswa: Tidak ada data.';
  const siswiTeks = dataSiswi?.absensi?.[tanggalPilih]
    ? formatRekap('siswi', dataSiswi, tanggalPilih)
    : 'Rekap Siswi: Tidak ada data.';
  ...
  alert(`Rekap absensi siswa & siswi tanggal ${tanggalPilih} berhasil disalin!`);
};
